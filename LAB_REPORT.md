...
- Đã lưu trữ ảnh chụp màn hình giao diện chat thực tế trên Web ADK:
  - `Screenshot 2026-08-28 165139.png`
  - `Screenshot 2026-08-28 165149.png`
- Thể hiện đầy đủ luồng: User hỏi → Gemini gọi tool qua Streamable HTTP tới FastMCP Server → Lấy dữ liệu thật từ WeatherAPI → Tổng hợp câu trả lời cho người dùng.
